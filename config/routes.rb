Rails.application.routes.draw do
  ...
  post("/update_director_record/:the_id",{ :controller => "directors", :action => "update" })
  ...
  post("/update_movie_record/:the_id",{ :controller => "movies", :action => "update" })
  ...
  post("/update_actor_record/:the_id",{ :controller => "actors", :action => "update" })
end
